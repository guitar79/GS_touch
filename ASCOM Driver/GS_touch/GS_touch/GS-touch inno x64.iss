...
#define MyAppName "ASCOM GS-touch x64"
#define MyAppVersion "Ver.1.1"
#define MyAppPublisher "ASCOM GS-touch x64"
#define MyAppExeName "ASCOM GS-touch x64 Ver.1.1.exe"
...
AppName = ASCOM GS-touch x64
AppVersion = Ver.1.1
AppVerName=ASCOM GS-touch Driver x64 Ver.1.1
AppPublisher = ASCOM GS-touch x64
...
OutputBaseFilename = Setup ASCOM GS-touch x64 Ver.1.1
Compression=lzma
...
[Files]
Source: "C:\Users\user\Documents\GitHub\Kevin_FCSH_controller\FCSH2\ASCOM Driver\GS_touch\GS_touch\bin\x64\Release\ASCOM.GS_touch.Focuser.dll"; DestDir: "{app}"; Flags: ignoreversion
